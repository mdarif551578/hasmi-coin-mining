    ...
    return (
        <Card className="rounded-2xl">
            ...
            <CardContent className="space-y-4">
                <div>
                    <div className="text-2xl md:text-3xl font-bold">{user.walletBalance.toLocaleString()} <span className="text-lg font-normal text-muted-foreground">HC</span></div>
                    <p className="text-xs text-muted-foreground">Hasmi Coin Balance</p>
                </div>
                <Separator />
                <div>
                    <div className="text-2xl md:text-3xl font-bold">${user.usdBalance.toFixed(2)} <span className="text-lg font-normal text-muted-foreground">USD</span></div>
